...
//        init();
    ...
    public void setChapterList(List<Chapter> chapterList){
        ...
        bookListRec.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, int i, int i1, long l) {
                ...
                Intent intent = PeriodActivity.getIntent(getActivity(), periodId, (String)adapter.getChild(i, i1));
    ...
    public void changeChapterList(int idBook){
        presenter.getChapterList(idBook);
    }
